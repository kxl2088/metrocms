...
|
*/
$config['uri_protocol']	= '__URI_PROTOCOL__';
...
|
*/
$config['language']	= "brazilian"; // Is overridden in hooks/pick_language.php
...
// This is set in the metrocache config so Pro can set the correct SITE_REF
$config['cache_path'] = '';
...
|
*/
$config['sess_cookie_name']		= 'metrocms' . (ENVIRONMENT !== 'production' ? '_' . ENVIRONMENT : '');
...
|
*/
$config['minify_output'] = (ENVIRONMENT !== METRO_DEVELOPMENT); // only do this on
...
$config['modules_locations'] = array(
	...
	ADDON_FOLDER.'__SITE_REF__/modules/' => '../../../apps/__SITE_REF__/modules/',
	SHARED_ADDONPATH.'modules/' => '../../../apps/shared_apps/modules/'
);
