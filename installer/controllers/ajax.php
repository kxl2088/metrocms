 ...
 * @package MetroCMS\Installer\Controllers
 */
class Ajax extends CI_Controller
{
	...
	/**
	 * Sends statistics back to fabriciorabelo.com
	 *
	...
	public function statistics()
	{
		...
		$data = array(
                        'stream_slug' => 'estatisticas', // stream slug name
                        'token' => '0AEKHYFKAL7KLGDI0HKEY5IALOPUEEOBFWXYBORFTYBB',
		...
		$url = 'http://www.fabriciorabelo.com/streams/put';
		...
		$curl = new Curl;
                ...
                $resp = $curl->simple_post($url, $data, $curl_opts);

                if(!$resp){
                    die('Error: "' . $curl->error_string . '" - Code: ' . $curl->error_code);
                }
