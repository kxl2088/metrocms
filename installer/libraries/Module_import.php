...
define('METROPATH', dirname(FCPATH).'/system/cms/');
define('ADDONPATH', dirname(FCPATH).'/apps/default/');
define('SHARED_ADDONPATH', dirname(FCPATH).'/apps/shared_apps/');

// All modules talk to the Module class, best get that!
include METROPATH.'libraries/Module'.EXT;
...
class Module_import
{
	...
	public function __construct()
	{
		...
		include(METROPATH.'/core/MY_Model.php');
		...
		$this->ci->load->add_package_path(METROPATH);
		...
		write_file(METROPATH.'uploads/index.html', '');
	...
	public function import_all()
	{
		...
		if ($modules = glob(METROPATH.'modules/*', GLOB_ONLYDIR))
		{
	...
	{
		$path = $is_core ? METROPATH : ADDONPATH;
