...
class Public_Controller extends MY_Controller
{
	...
	public function __construct()
	{
		...
		if (Settings::get('cdn_domain'))
		{
			...
			// Make cdn.fabriciorabelo.com into https://cdn.fabriciorabelo.com/
