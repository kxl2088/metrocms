...
class Cpanel_Api {
    ...
    public function __construct( $param = array() ){
        ...
        $this->CI->config->load('cpanel');
        
        $config['cpanel']['host']     = $this->CI->config->item('cpanel_api_host');
        $config['cpanel']['port']     = $this->CI->config->item('cpanel_api_port');
        $config['cpanel']['ssl']      = $this->CI->config->item('cpanel_api_ssl');
        $config['cpanel']['username'] = $this->CI->config->item('cpanel_api_username');
        $config['cpanel']['password'] = $this->CI->config->item('cpanel_api_password');
            
        $param_config = $config['cpanel'];
