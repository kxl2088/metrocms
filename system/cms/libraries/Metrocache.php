 ...
 *
 * @category	MetroCMS\Core\Libraries\MetroCache
...
class Metrocache
{
	...
	public function __construct()
	{
		...
		$this->_ci->load->config('metrocache');
	...
	/**
	 * Use MetroCache::model() or MetroCache::library() instead of this.
	 *
	 * @see MetroCache::model(), MetroCache::library()
	 * @todo Document this function's parameters.
	 * @param $property
	 * @param $method
	 * @param array $arguments
	 ...
	 *
	 * <code>
	 * $this->metrocache->write($data, 'nav_title');
	 * $this->metrocache->write($links, 'nav_links');
	 * $this->metrocache->delete_group('nav_');
	 * </code>
	 *
