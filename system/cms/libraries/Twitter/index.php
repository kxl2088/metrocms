...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	...
	private $cache_dir = '../../cache/default/twitter/';
	...
	public function __construct($config = array()) {
                ...
                $this->user_token = $config['twitter_user_token'];
                $this->user_secret = $config['twitter_user_secret'];
                $this->cache_enabled = $config['twitter_cache_enabled'];
	...
	private function generateCFID() {
		...
		return md5(serialize($_POST)).'.cache';
	}
...
// Initialize class loading the $config array
