		...
		foreach ($files as $file)
		{
			...
			if (class_exists($class_name))
			{
				...
				array_push($plugins, array(
					...
					'slug' => $slug,
					'description' => (isset($plugin->description[CURRENT_LANGUAGE])) ? $plugin->description[CURRENT_LANGUAGE] : (isset($plugin->description[CURRENT_LANGUAGE])) ? $plugin->description[CURRENT_LANGUAGE] : ((isset($plugin->description['en'])) ? $plugin->description['en'] : null),
