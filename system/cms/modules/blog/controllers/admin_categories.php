...
class Admin_Categories extends Admin_Controller
{
	...
	{
		$this->metrocache->delete_all('module_m');
	...
	public function create()
	{
		...
		if ($this->form_validation->run())
		{
                        ...
                        $input['slug'] = $this->slug->create_uri(array('title' => $this->input->post('title')));
	...
	public function edit($id = 0)
	{
		...
		{
                        $input = $this->input->post();
                        $input['slug'] = $this->slug->create_uri(array('title' => $this->input->post('title')), $id);
                        
			$this->blog_categories_m->update($id, $input)
	...
	public function create_ajax()
	{
		...
		if ($this->form_validation->run())
		{
			...
			$id = $this->blog_categories_m->insert_ajax($input);
