 ...
 * @package  MetroCMS\Core\Modules\Blog\Plugins
 */
class Plugin_Blog extends Plugin
{
	...
	public function _self_doc()
	{
		...
		$info = array(
			'posts' => array(
				...
				'double' => true,
				'variables' => 'category_title|category_slug|author_id|author_name|title|slug|url|category_id|intro|body|parsed|created_on|updated_on|count',// the variables available inside the double tags
	...
	public function posts()
	{
		...
		$order_by  = $this->attribute('order-by', 'created');
	...
	public function archive()
	{
		...
		$this->lang->load('blog/blog');
                ...
                $archive = $this->blog_m->get_archive_months();

		foreach($archive as $a)
		{
			$a->url = site_url('blog/archive/'.date('Y/m', $a->date));
                        $a->count = $a->post_count;
                        $a->title = format_date($a->date, lang('blog:archive_date_format'));
		}		
