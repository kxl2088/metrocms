<div class="row-fluid">
    <div class="span12">
        <div class="content-widgets">
            <section class="widget-head blue title skip">
                    <h3 id="file-title">
                            <?php echo lang('files:files_title') ?>
                    </h3>

                    <div class="widget-head-buttons" id="file-toolbar">
                            <div id="file-buttons">
                                    <ul class="button-menu-source buttons">
                                            <li class="btn btn-primary animated fadeIn" data-applies-to="pane root-pane"	data-menu="refresh"><?php echo lang('files:refresh') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-applies-to="folder" data-menu="open"><?php echo lang('files:open') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="create_folder"	data-applies-to="pane root-pane" data-menu="new-folder"><?php echo lang('files:new_folder') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="upload" data-applies-to="folder pane" data-menu="upload"><?php echo lang('files:upload') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="edit_file" data-applies-to="file" data-menu="rename"><?php echo lang('files:rename') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="edit_folder" data-applies-to="folder" data-menu="rename"><?php echo lang('files:rename') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="download_file" data-applies-to="file" data-menu="download"><?php echo lang('files:download') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="synchronize" data-applies-to="folder" data-menu="synchronize"><?php echo lang('files:synchronize') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="upload delete_file" data-applies-to="file" data-menu="replace"><?php echo lang('files:replace') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="delete_file" data-applies-to="file" data-menu="delete"><?php echo lang('files:delete') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-role="delete_folder" data-applies-to="folder" data-menu="delete"><?php echo lang('files:delete') ?></li>
                                            <li class="btn btn-primary animated fadeIn" data-applies-to="folder file pane"	data-menu="details"><?php echo lang('files:details') ?></li>
                                    </ul>
                            </div>
...
<section class="widget-container span12 item skip">
	<section class="side skip">
	...
	<section class="side sidebar-right animated skip" id="file-sidebar">
		<button class="close btn btn-danger" alt="close"><?php echo lang('buttons:close'); ?></button>
	...
	<div class="hidden">
		...
		<div id="item-details">
			...
			<ul>
				...
				<li class="show-data">
					<button class="btn btn-primary"><?php echo lang('files:toggle_data_display') ?></button>
				</li>
			</ul>
			...
			<ul class="meta-data">
				...
				<li><label><?php echo lang('files:bucket') ?>:</label> 
					...
					<a class="container-button btn btn-primary"><?php echo lang('files:check_container') ?></a>
				</li>
				<li><label><?php echo lang('files:container') ?>:</label> 
			...
			<ul class="item-description">
				...
				<li><label><?php echo lang('global:keywords') ?>:</label>
...
<section class="widget-head orange file-path skip">
