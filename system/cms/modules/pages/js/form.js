	...
	$(function(){
		...
		$('a.add-chunk').click( function(e){
			...
			$('#page-chunks').append('<li class="page-chunk">' +
				...
				'<a href="javascript:void(0)" class="remove-chunk btn red">' + metro.lang.remove + '</a>' +
		...
		$('a.remove-chunk').click( function(e) {
			e.preventDefault();

			var removemsg = $(this).attr('title');

			if (confirm(removemsg || metro.lang.dialog_message))
			{
		...
		$('select[name^=chunk_type]').change( function() {
