(function($) {
	$(function() {
		...
		// set values for metro.sort_tree (we'll use them below also)
		...
		$item_list.find('li a').click( function(e) {
			e.preventDefault();
		...
		// And off we go
		metro.sort_tree($item_list, $url, $cookie, data_callback, post_sort_callback);
