...
<div class="buttons">
	<?php 
		...
		else
		{
			...
			echo anchor('admin/pages/create?parent='.$page->id.'&page_type='.$type_id, lang('pages:create_label'), 'class="btn btn-primary"');
		}

	?>
	<?php echo anchor('admin/pages/duplicate/'.$page->id, lang('pages:duplicate_label'), 'class="btn btn-warning"') ?>
	<?php echo anchor('admin/pages/edit/'.$page->id, lang('global:edit'), 'class="btn btn-primary"') ?>
