                                        ...
                                        <th width="30%"></th>
                                            ...
                                            <td><?php echo $page_type->description;?></td>
                                                                            <td class="actions">
                                                                                    ...
                                                                                    <?php echo anchor('admin/pages/types/sync/'.$page_type->id, lang('page_types:sync_files'), array('class'=>'btn btn-success'));?> 
                                                                                    <?php endif; ?>

                                                                                    <?php echo anchor('admin/pages/types/fields/'.$page_type->id, lang('global:fields'), array('class'=>'btn btn-info'));?> 
                                                                                    <?php echo anchor('admin/pages/types/edit/' . $page_type->id, lang('global:edit'), array('class'=>'btn btn-primary'));?> 
                                                                                    <?php if ($page_type->slug !== 'default') echo anchor('admin/pages/types/delete/' . $page_type->id, lang('global:delete'), array('class'=>'btn btn-danger confirm'));?>
                                                                            </td>
                                                                    </tr>
                                                            <?php endforeach; ?>
                                                    </tbody>
