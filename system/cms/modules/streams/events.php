...
/**
 * MetroStreams Event Class
 *
 * Currently, this plugs into the admin_notification to use MetroStreams validation.
 * 
...
class Events_Streams {
    ...
    /**
     * Display MetroStreams custom notifications
     *
     * @access	public
     * @return	void
     */
    ...
    {
        $this->CI->metrocache->delete_all('row_m');
        $this->CI->metrocache->delete_all('metrostreams');
    }
