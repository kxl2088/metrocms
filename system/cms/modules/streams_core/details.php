...
/**
 * MetroStreams Core Module
 *
 * @package        MetroCMS\Core\Modules\Streams Core
 * @author         Parse19
...
class Module_Streams_core extends Module
{
	...
	/**
	 * Install MetroStreams Core Tables
	 *
	 * @return bool
	 */
	...
	private function _load_config()
	{
		...
		{
			require_once(METROPATH.'modules/streams_core/config/streams.php');
		}
