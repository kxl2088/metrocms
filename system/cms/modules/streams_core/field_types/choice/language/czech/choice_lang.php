...
$lang['streams:choice.instructions'] 		= 'Napište každou možnost na jeden řádek. Pokud chcete oddělit hodnotu pro každou možnost, můžete použít dvojtečku (:). Např.<pre>MetroCMS'."\n".'metro : MetroCMS</pre>';
