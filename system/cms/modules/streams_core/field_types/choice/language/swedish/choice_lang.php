...
$lang['streams:choice.instructions']		= "Skriv varje val på en rad. Ifall du vill ha ett separat värde för varje val så separera dem med kolon (:) Ex: <pre>MetroCMS\nmetro : MetroCMS</pre>";
