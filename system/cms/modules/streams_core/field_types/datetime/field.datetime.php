...
/**
 * MetroStreams Date/Time Field Type
 *
...
{	
	...
	public function param_use_time($value = '')
	{
		...
		$form  = '<ul><li><label>'.form_radio('use_time', 'yes', $yes_select).lang('global:yes').' </label></li>';
		
		$form .= '<li><label>'.form_radio('use_time', 'no', $no_select).lang('global:no').' </label></li>';
