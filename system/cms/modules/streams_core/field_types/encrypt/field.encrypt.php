...
/**
 * MetroStreams Encrypt Field Type
 *
...
class Field_encrypt
{
	...
	public function pre_output($input)
	{
		...
		// No MetroCMS tags in your ouput!
	...
	public function param_hide_typing($params = false)
	{
		...
		$form  = '<ul><li><label>'.form_radio('hide_typing', 'yes', $yes_select).lang('global:yes').' </label></li>';
		
		$form .= '<li><label>'.form_radio('hide_typing', 'no', $no_select).lang('global:no').' </label></li></ul>';
