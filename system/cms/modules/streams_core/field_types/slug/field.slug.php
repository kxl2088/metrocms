...
class Field_slug
{
	 ...
	 * Pre Save
	 *
	 * No MetroCMS tags in slug fields.
	 *
	 * @return string
	 */
	...
	public function form_output($params)
	{
		...
		$jquery = "<script>(function($) {
			$(function(){
					metro.generate_slug('#{$params['custom']['slug_field']}', '#{$params['form_slug']}', '{$params['custom']['space_type']}');
			});
		})(jQuery);
		</script>";
