...
$lang['streams:stream_field_ass_add_success']			= "Campo adicionado para o fluxo de dados com sucesso.";
...
$lang['streams:delete_summary']					= "Tem certeza de que deseja excluír o fluxo de dados <strong>%s</strong>? Será <strong>excluído %s %s</strong> permanentemente.";
...
$lang['streams:cannot_find_metrostreams']			= "Não foi possível encontrar o Metro Fluxo."; 
...
$lang['streams:edit_assign']					= "Editar Atribuição do Fluxo";
...
$lang['streams:field_assignments'] 				= "Atribuições de Campos do Fluxo";
...
$lang['streams:backup_table']					= "Backup da Tabela de Fluxo";
...
$lang['streams:start.no_streams']				= "Ainda não há fluxos de dados, mas vocêjá pode começar";
$lang['streams:start.no_streams_yet']				= "Não há fluxos de dados ainda."; 
$lang['streams:start.adding_one']				= "adicionando um";
$lang['streams:start.no_fields_to_add']				= "Sem campos para adicionar";
$lang['streams:start.no_fields_msg']				= "Não existem campos para adicionar a este fluxo. Em Metro Fluxos, os tipos de campos podem ser compartilhados entre fluxos e deve ser criado antes de ser adicionado a um fluxo. Você pode começar por";
...
$lang['streams:no_fields_msg_first']				= "Parece que ainda não há campos atribuídos para este fluxo."; 
...
$lang['streams:stream_data_line']				= "Editar dados básicos do fluxo.";
