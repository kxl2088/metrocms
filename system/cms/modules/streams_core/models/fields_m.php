...
class Fields_m extends CI_Model {
	 ...
	 * @return	bool
	 */
	public function insert_field($field_name, $field_slug, $field_type, $field_namespace, $extra = array(), $locked = FALSE)
	{
		if ( ! $locked )
		{
			$locked = 'no';
	...
	public function delete_field($field_id)
	{
		...
		// is the field we are deleting. MetroStreams will
