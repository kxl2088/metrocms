CKEDITOR.plugins.add('metroimages',
{
    ...
    {
        CKEDITOR.dialog.addIframe('metroimage_dialog', 'Image', SITE_URL + 'admin/wysiwyg/image',800,500)
        editor.addCommand('metroimages', {exec:metroimage_onclick});
        editor.ui.addButton('metroimages',{ label:'Upload or insert images from library', command:'metroimages', icon:this.path+'images/icon.png' });
