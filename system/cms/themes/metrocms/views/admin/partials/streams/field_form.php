                ...
                <div class="form_inputs">
                                ...
                                <div class="control-group">
                                        ...
                                        <div class="input controls">
                                                ...
                                                {
                                                        echo $current_field->is_locked == 'yes' ? $field->field_name . form_hidden('field_name', $field->field_name) : form_input('field_name', $field->field_name, 'maxlength="60" id="field_name" autocomplete="off"');
                                                }
                                ...
                                <div class="control-group">
                                        <label class="control-label" for="field_slug"><?php echo lang('streams:label.field_slug');?> <span>*</span><br /><?php if($current_field->is_locked == 'no'): ?><small><?php echo lang('global:slug_instructions'); ?></small><?php endif; ?></label>
                                        <div class="input controls"><?php echo $current_field->is_locked == 'yes' ? $field->field_slug . form_hidden('field_slug', $field->field_slug) : form_input('field_slug', $field->field_slug, 'maxlength="60" id="field_slug"'); ?></div>
                                </div>
                                ...
                                <div class="control-group">
                                        ...
                                        <div class="input controls"><?php echo form_checkbox('is_required', 'yes', $is_required, 'id="is_required"');?></div>
                                </div>
                                ...
                                <div class="control-group">
                                        ...
                                        <div class="input controls"><?php echo form_checkbox('is_unique', 'yes', $is_unique, 'id="is_unique"'); ?></div>
                                </div>
                                ...
                                <div class="control-group">
                                        ...
                                        <div class="input controls"><?php echo ((substr($field->instructions, 0, 5) === 'lang:' and lang(substr($field->instructions, 5))) ? lang(substr($field->instructions, 5)) . form_hidden('instructions', $field->instructions, 'id="field_instructions"') : form_textarea('instructions', $field->instructions, 'id="field_instructions"'));?></div>
                                </div>
                                ...
                                <div class="control-group">
                                        ...
                                        <div class="inputs controls"><?php echo form_checkbox('title_column', 'yes', $title_column_status, 'id="title_column"');?></div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="float-right buttons">
                                    ...
                                    <?php if ($cancel_uri): ?>
                                    <a href="<?php echo site_url($cancel_uri); ?>" class="btn btn-danger cancel"><?php echo lang('buttons:cancel'); ?></a>
                                    <?php endif; ?>
                                </div>
                </div>
                    <?php echo form_close();?>
