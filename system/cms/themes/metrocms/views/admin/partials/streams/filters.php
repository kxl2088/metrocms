<?php if ( $filters != null ): ?>
<fieldset id="filters" class="form-filters">
	...
	<ul>  
		...
		<li>
			<div class="buttons">
				<?php echo form_submit('filter-'.$stream->stream_slug, lang('buttons:filter'), 'class="btn btn-primary"'); ?>
				<?php echo anchor(current_url(), lang('buttons:clear'), 'class="btn btn-danger"'); ?>
			</div>
		</li>
	</ul>
	<?php echo form_close(); ?>
