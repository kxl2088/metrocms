...
abstract class CI_DB_forge {
	 ...
	 * @return	version
         * @return	row format
         * @return	avg row lenght
         * @return	data lenght
         * @return	max data lenght
         * @return	index lenght
         * @return	data free
	...
	public function table_status($table = '')
	{
		...
		return FALSE;
         ...
         /**
	 * Modify auto increment column
	 *
         * @return	bool
         * 
	 */
	public function modify_auto_increment($table = '', $int = '')
	{
		if ($table === '' && $int === '')
		{
			show_error('A table name is required for that operation.');
                ...
                if($table && $int)
                {
                    $query = $this->db->query('ALTER TABLE `' . $this->db->dbprefix.$table . '` AUTO_INCREMENT = ' . $int);
